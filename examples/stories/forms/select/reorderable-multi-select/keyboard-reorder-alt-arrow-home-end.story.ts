...
export const STORY: DemoSpec = {
  title: 'Keyboard reorder — Alt + Arrow / Home / End',
  subtitle:
  ...
  description:
    'CngxReorderableMultiSelect — multi-value picker whose selected chips can be reordered via pointer drag and Alt+Arrow keyboard moves. Thin organism on top of createSelectCore + CngxReorder.',
  level: 'organism',
