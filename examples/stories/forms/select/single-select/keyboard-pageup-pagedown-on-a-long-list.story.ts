...
export const STORY: DemoSpec = {
  title: 'CngxSelect: keyboard pageup pagedown on a long list',
  ...
  references: [
    { label: 'WAI-ARIA APG: Listbox keyboard interaction', href: 'https://www.w3.org/WAI/ARIA/apg/patterns/listbox/#keyboardinteraction' },
  ],
};
