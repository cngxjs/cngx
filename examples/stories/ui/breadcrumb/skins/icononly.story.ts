...
export const STORY: DemoSpec = {
  ...
  description:
    'The bar always wraps the label in a <code>.cngx-breadcrumb__label</code> span and sets <code>[data-label]</code>, so hiding is a skin concern, not a template branch: the label remains in the DOM as the link name (Pillar 2), and the tooltip is decorative. Icons are <code>aria-hidden</code>. Fills resolve from <code>--cngx-color-*</code> in the skin scope; retint via the <code>--cngx-breadcrumb-icononly-*</code> tokens.',
  level: 'organism',
