...
export const STORY: DemoSpec = {
  title: 'CngxTabGroup: vertical sidebar tabs',
  subtitle: 'Pass <code>orientation="vertical"</code>. <code>aria-orientation</code> on the tablist plus <code>data-orientation</code> on the wrapper drive the layout split.',
  description: 'Layout variant: vertical tab rail with panel column on the right. Roving tabindex auto-switches to ArrowUp/ArrowDown semantics, and <code>aria-orientation</code> + <code>data-orientation</code> drive the CSS grid split.',
  level: 'organism',
