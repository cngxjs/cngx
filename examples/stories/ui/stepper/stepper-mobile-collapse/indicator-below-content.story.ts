...
export const STORY: DemoSpec = {
  ...
  subtitle:
    'The dot row drops below the panel content via <code>[mobileIndicatorPosition]="bottom"</code>. App-wide consumers reach the same default through <code>provideStepperConfig(withStepperMobileIndicatorPosition(\'bottom\'))</code>. The collapse threshold is a <code>@container</code> rule in the stepper stylesheet, so this demo pins the collapsed branch with the consumer-side override the contract promises: <code>.demo-force-collapse .cngx-stepper::after { --cngx-stepper-collapse: 1 }</code>. The flip is visible without resizing.',
  description:
