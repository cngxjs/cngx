...
export const STORY: DemoSpec = {
  ...
  subtitle:
    'Horizontal swipe advances and retreats the active step while the stepper is in mobile-collapse mode. The composition is built-in via <code>[mobileSwipe]</code> (default <code>true</code>); app-wide consumers reach the same default through <code>provideStepperConfig(withStepperMobileSwipe(false))</code>. The collapse threshold is a <code>@container</code> rule in the stepper stylesheet, so this demo pins the collapsed branch with the consumer-side override the contract promises: <code>.demo-force-collapse .cngx-stepper::after { --cngx-stepper-collapse: 1 }</code>. The panel-region swipe is visible without resizing.',
  description:
  ...
  template: `  <div class="demo-force-collapse">
    <cngx-stepper
