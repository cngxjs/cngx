...
export const STORY: DemoSpec = {
  ...
  subtitle: 'Resize the window below 480px. The classic strip collapses to <code>&lt;cngx-text-stepper&gt;</code> via <code>withStepperMobileCollapse(\'text\')</code>. Use <code>\'dots\'</code> or <code>\'off\'</code> to switch.',
