...
export const STORY: DemoSpec = {
  ...
  description: 'Slot focus: <code>*cngxStepBusySpinner</code>. An 800ms pessimistic commit reliably triggers the pending state so the slot is observable, and the spinner chip carries a tokenised background so it themes with the host.',
  level: 'organism',
  audience: ['dev', 'design'],
  artifact: 'standalone',
