...
export const STORY: DemoSpec = {
  ...
  description:
    'The opinionated preset from @cngx/ui/command-palette over the headless @cngx/common/command registry. Commands register through provideCommands(...) (scoped here to the demo component) and run real actions (density, theme, scroll), grouped into Appearance and Navigation. The molecule this composes - the raw CngxListboxSearch + listbox seam - lives at /common/interactive/listbox/search/command-palette.',
  level: 'organism',
  audience: ['dev', 'a11y'],
  artifact: 'standalone',
