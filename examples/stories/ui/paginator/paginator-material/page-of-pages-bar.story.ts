...
export const STORY: DemoSpec = {
  ...
  template: `  <cngx-paginator skin="bar" [total]="100" [pageIndex]="pageIndex()" (pageIndexChange)="pageIndex.set($event)" [pageSize]="pageSize()" (pageSizeChange)="pageSize.set($event)">
