...
export const STORY: DemoSpec = {
  ...
  subtitle: 'Scroll to the bottom to load more items. The sentinel element triggers <code>(scrolled)</code> when it enters the viewport. Loading stops at 100 items.',
