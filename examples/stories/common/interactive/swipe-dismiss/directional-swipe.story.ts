...
export const STORY: DemoSpec = {
  ...
  subtitle: 'Swipe the box in the selected direction to trigger dismissal. <code>swipeProgress</code> updates in real time during the gesture (0 to 1). <code>(swiped)</code> emits when the threshold is exceeded.',
