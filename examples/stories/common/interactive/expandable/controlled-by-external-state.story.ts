...
export const STORY: DemoSpec = {
  ...
  subtitle: 'Bind <code>[cngxExpandableOpen]</code> to a parent signal; the directive\'s internal state is bypassed, <code>(expandedChange)</code> still fires so consumers can route the user-driven update.',
