...
export const STORY: DemoSpec = {
  ...
  subtitle:
    '<code>[tree]</code> takes a <code>CngxTreetableNode&lt;T&gt;</code> root (or an array of roots); the grid flattens it, seeds a fully expanded state, and manages expand/collapse itself. <code>selectionMode="single"</code> holds at most one selected row. <code>(nodeClicked)</code> fires the full <code>CngxTreetableFlatNode</code> on every row activation, mouse or keyboard.',
  description:
  ...
  moduleImports: [
    "import { CngxTreetable, type CngxTreetableFlatNode } from '@cngx/data-display/treetable';",
  ...
  protected handleNodeClick(node: CngxTreetableFlatNode<Employee>): void {
