...
// Source: dev-app/src/app/demos/ui/stepper/stepper-custom-labels-demo/stepper-custom-labels-demo.story.ts#section[0] "Mixing <code>[label]</code> Input with <code>cngxStepLabel</code> slot"
