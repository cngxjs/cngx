...
// Source: examples/stories/ui/stepper/stepper-slot-overrides-demo/stepper-slot-overrides-demo.story.ts#section[0] "Custom indicator glyph via <code>*cngxStepIndicator</code>"
