...
// Source: examples/stories/ui/stepper/stepper-slot-overrides-demo/stepper-slot-overrides-demo.story.ts#section[1] "Custom error badge via <code>*cngxStepBadge</code>"
