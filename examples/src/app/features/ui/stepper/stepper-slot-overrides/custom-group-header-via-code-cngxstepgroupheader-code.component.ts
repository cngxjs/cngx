...
// Source: dev-app/src/app/demos/ui/stepper/stepper-slot-overrides-demo/stepper-slot-overrides-demo.story.ts#section[4] "Custom group header via <code>*cngxStepGroupHeader</code>"
