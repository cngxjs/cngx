...
// Source: dev-app/src/app/demos/ui/stepper/stepper-slot-overrides-demo/stepper-slot-overrides-demo.story.ts#section[5] "Empty-state placeholder via <code>*cngxStepperEmpty</code>"
