...
// Source: examples/stories/ui/stepper/stepper-slot-overrides-demo/stepper-slot-overrides-demo.story.ts#section[3] "Custom busy-spinner via <code>*cngxStepBusySpinner</code>"
