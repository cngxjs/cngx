...
// Source: dev-app/src/app/demos/ui/tabs/tab-slot-overrides-demo/tab-slot-overrides-demo.story.ts#section[0] "Custom error badge via <code>*cngxTabErrorBadge</code>"
