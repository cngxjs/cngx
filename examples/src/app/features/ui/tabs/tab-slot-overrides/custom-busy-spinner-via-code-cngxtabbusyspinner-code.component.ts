...
// Source: examples/stories/ui/tabs/tab-slot-overrides-demo/tab-slot-overrides-demo.story.ts#section[2] "Custom busy-spinner via <code>*cngxTabBusySpinner</code>"
