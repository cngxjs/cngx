...
// Source: examples/stories/ui/tabs/tab-slot-overrides-demo/tab-slot-overrides-demo.story.ts#section[1] "Rejection-decoration via <code>*cngxTabRejectionIcon</code>"
