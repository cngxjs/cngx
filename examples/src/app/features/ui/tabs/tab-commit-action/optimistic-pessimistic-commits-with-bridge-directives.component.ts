...
// Source: examples/stories/ui/tabs/tab-commit-action-demo/tab-commit-action-demo.story.ts#section[0] "Optimistic + pessimistic commits with bridge directives"
