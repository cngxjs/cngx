...
// Source: dev-app/src/app/demos/ui/feedback/progress-demo/progress-demo.story.ts#section[0] "Linear — Indeterminate"

import { ChangeDetectionStrategy, Component, signal } from '@angular/core';
import { CngxProgress } from '@cngx/ui/feedback';

@Component({
  selector: 'app-progress-linear-indeterminate',
...
export class ProgressLinearIndeterminate {
  ...
  protected readonly _exSectionTitle: string = 'Linear — Indeterminate';
  protected readonly _exSubtitle: string = 'Default state when no progress value is set.';
