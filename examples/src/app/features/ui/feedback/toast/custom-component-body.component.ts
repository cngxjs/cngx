...
// Source: dev-app/src/app/demos/ui/feedback/toast-demo/toast-demo.story.ts#section[2] "Custom Component Body"
...
@Component({
  selector: 'app-toast-custom-component-body',
...
export class ToastCustomComponentBody {
  ...
  protected readonly _exSectionTitle: string = 'Custom Component Body';
  protected readonly _exSubtitle: string = 'Pass a <code>content</code> component to <code>ToastConfig</code> for rich toast bodies. Rendered via <code>NgComponentOutlet</code>.';
  protected readonly _exTags: readonly { dim: string; value: string }[] = [];
  protected readonly _exUses: readonly string[] = ['CngxToastOutlet', 'CngxToastOn', 'CngxToaster', 'CngxToast'];
