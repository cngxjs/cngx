...
// Source: dev-app/src/app/demos/ui/feedback/toast-demo/toast-demo.story.ts#section[4] "State Bridge ([cngxToastOn])"

import { ChangeDetectionStrategy, Component, inject, signal } from '@angular/core';
import { CngxToaster, CngxToastOn } from '@cngx/ui/feedback';
import { createManualState } from '@cngx/common/data';
import { SampleToastBody } from './sample-toast-body';

@Component({
  selector: 'app-toast-state-bridge-cngxtoaston',
...
export class ToastStateBridgeCngxtoaston {
