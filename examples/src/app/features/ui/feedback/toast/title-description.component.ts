...
// Source: dev-app/src/app/demos/ui/feedback/toast-demo/toast-demo.story.ts#section[1] "Title + Description"
...
@Component({
  selector: 'app-toast-title-description',
...
export class ToastTitleDescription {
