...
// Source: dev-app/src/app/demos/forms/select-demo/select-demo.story.ts#section[21] "Multi — clearable"
...
@Component({
  selector: 'app-select-multi-clearable',
...
export class SelectMultiClearable {
