...
// Source: dev-app/src/app/demos/forms/select-demo/select-demo.story.ts#section[23] "Multi — text summary via *cngxMultiSelectTriggerLabel"
...
@Component({
  selector: 'app-select-multi-text-summary-via-cngxmultiselecttriggerlabel',
...
export class SelectMultiTextSummaryViaCngxmultiselecttriggerlabel {
