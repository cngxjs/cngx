...
// Source: dev-app/src/app/demos/forms/select-demo/select-demo.story.ts#section[7] "Async state consumer"
...
@Component({
  selector: 'app-select-async-state-consumer',
...
export class SelectAsyncStateConsumer {
