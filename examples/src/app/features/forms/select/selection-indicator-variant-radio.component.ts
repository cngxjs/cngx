...
// Source: dev-app/src/app/demos/forms/select-demo/select-demo.story.ts#section[13] "Selection indicator variant: radio"
...
@Component({
  selector: 'app-select-selection-indicator-variant-radio',
...
export class SelectSelectionIndicatorVariantRadio {
