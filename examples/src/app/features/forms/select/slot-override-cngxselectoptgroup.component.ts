...
// Source: dev-app/src/app/demos/forms/select-demo/select-demo.story.ts#section[35] "Slot override: *cngxSelectOptgroup"
...
export class SelectSlotOverrideCngxselectoptgroup {
