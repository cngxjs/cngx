...
// Source: dev-app/src/app/demos/forms/select-demo/select-demo.story.ts#section[28] "Combobox — clearable + custom *cngxSelectClearButton"
...
@Component({
  selector: 'app-select-combobox-clearable-custom-cngxselectclearbutton',
...
export class SelectComboboxClearableCustomCngxselectclearbutton {
