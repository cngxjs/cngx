...
// Source: dev-app/src/app/demos/forms/select-demo/select-demo.story.ts#section[18] "Signal Forms (required)"
...
@Component({
  selector: 'app-select-signal-forms-required',
...
export class SelectSignalFormsRequired {
