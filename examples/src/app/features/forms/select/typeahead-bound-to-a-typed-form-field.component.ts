...
// Source: dev-app/src/app/demos/forms/select-demo/select-demo.story.ts#section[32] "Typeahead — bound to a typed form field"
...
@Component({
  selector: 'app-select-typeahead-bound-to-a-typed-form-field',
...
export class SelectTypeaheadBoundToATypedFormField {
