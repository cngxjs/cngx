...
// Source: dev-app/src/app/demos/forms/select-demo/select-demo.story.ts#section[9] "Loading variants"
...
@Component({
  selector: 'app-select-loading-variants',
...
export class SelectLoadingVariants {
