...
// Source: dev-app/src/app/demos/forms/select-demo/select-demo.story.ts#section[33] "Slot override: *cngxSelectPlaceholder"
...
@Component({
  selector: 'app-select-slot-override-cngxselectplaceholder',
...
export class SelectSlotOverrideCngxselectplaceholder {
