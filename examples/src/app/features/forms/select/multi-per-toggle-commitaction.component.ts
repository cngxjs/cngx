...
// Source: dev-app/src/app/demos/forms/select-demo/select-demo.story.ts#section[23] "Multi — per-toggle [commitAction]"
...
@Component({
  selector: 'app-select-multi-per-toggle-commitaction',
...
export class SelectMultiPerToggleCommitaction {
