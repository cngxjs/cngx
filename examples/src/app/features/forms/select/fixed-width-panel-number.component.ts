...
// Source: dev-app/src/app/demos/forms/select-demo/select-demo.story.ts#section[15] "Fixed-width panel (number)"
...
@Component({
  selector: 'app-select-fixed-width-panel-number',
...
export class SelectFixedWidthPanelNumber {
