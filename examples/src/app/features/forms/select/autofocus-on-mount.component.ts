...
// Source: dev-app/src/app/demos/forms/select-demo/select-demo.story.ts#section[17] "Autofocus on mount"
...
@Component({
  selector: 'app-select-autofocus-on-mount',
...
export class SelectAutofocusOnMount {
