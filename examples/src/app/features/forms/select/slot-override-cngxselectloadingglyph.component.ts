...
// Source: dev-app/src/app/demos/forms/select-demo/select-demo.story.ts#section[40] "Slot override: *cngxSelectLoadingGlyph"
...
@Component({
  selector: 'app-select-slot-override-cngxselectloadingglyph',
...
export class SelectSlotOverrideCngxselectloadingglyph {
