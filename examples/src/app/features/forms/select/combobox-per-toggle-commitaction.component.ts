...
// Source: dev-app/src/app/demos/forms/select-demo/select-demo.story.ts#section[27] "Combobox — per-toggle [commitAction]"
...
@Component({
  selector: 'app-select-combobox-per-toggle-commitaction',
...
export class SelectComboboxPerToggleCommitaction {
