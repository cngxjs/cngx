...
// Source: dev-app/src/app/demos/forms/select-demo/select-demo.story.ts#section[1] "Assemble it yourself — atoms + element components"
...
@Component({
  selector: 'app-select-assemble-it-yourself-atoms-element-components',
...
export class SelectAssembleItYourselfAtomsElementComponents {
