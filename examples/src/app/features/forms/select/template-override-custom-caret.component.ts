...
// Source: dev-app/src/app/demos/forms/select-demo/select-demo.story.ts#section[11] "Template override: custom caret"
...
@Component({
  selector: 'app-select-template-override-custom-caret',
...
export class SelectTemplateOverrideCustomCaret {
