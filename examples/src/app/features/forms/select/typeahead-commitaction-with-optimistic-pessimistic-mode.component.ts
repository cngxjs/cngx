...
// Source: dev-app/src/app/demos/forms/select-demo/select-demo.story.ts#section[43] "Typeahead — [commitAction] with optimistic/pessimistic mode"
...
@Component({
  selector: 'app-select-typeahead-commitaction-with-optimistic-pessimistic-mode',
...
export class SelectTypeaheadCommitactionWithOptimisticPessimisticMode {
