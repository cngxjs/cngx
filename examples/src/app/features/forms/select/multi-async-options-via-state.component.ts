...
// Source: dev-app/src/app/demos/forms/select-demo/select-demo.story.ts#section[22] "Multi — async options via [state]"
...
@Component({
  selector: 'app-select-multi-async-options-via-state',
...
export class SelectMultiAsyncOptionsViaState {
