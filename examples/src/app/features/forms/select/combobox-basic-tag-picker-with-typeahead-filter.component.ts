...
// Source: dev-app/src/app/demos/forms/select-demo/select-demo.story.ts#section[26] "Combobox — basic (tag picker with typeahead filter)"
...
@Component({
  selector: 'app-select-combobox-basic-tag-picker-with-typeahead-filter',
...
export class SelectComboboxBasicTagPickerWithTypeaheadFilter {
