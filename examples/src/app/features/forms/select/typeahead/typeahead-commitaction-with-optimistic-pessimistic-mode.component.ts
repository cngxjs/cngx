...
// Source: dev-app/src/app/demos/forms/typeahead-demo/typeahead-demo.story.ts#section[3] "Typeahead — [commitAction] with optimistic/pessimistic mode"
...
@Component({
  selector: 'app-typeahead-typeahead-commitaction-with-optimistic-pessimistic-mode',
...
export class TypeaheadTypeaheadCommitactionWithOptimisticPessimisticMode {
  ...
  protected readonly _exSectionTitle: string = 'Typeahead — [commitAction] with optimistic/pessimistic mode';
  protected readonly _exSubtitle: string = 'Same commit machinery as CngxSelect. Pick a user — the action runs for 800ms. Toggle mode to compare panel-close timing (optimistic closes immediately + rolls back on error; pessimistic keeps panel open until success). Fail-next button forces the action into the error path.';
