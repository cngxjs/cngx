...
// Source: dev-app/src/app/demos/forms/typeahead-demo/typeahead-demo.story.ts#section[4] "Typeahead — *cngxSelectOptionLabel slot override"

import { ChangeDetectionStrategy, Component, signal } from '@angular/core';
import { form, schema, required } from '@angular/forms/signals';
import { CngxSelectOptionLabel, CngxTypeahead, type CngxSelectCommitAction, type CngxSelectOptionDef, type CngxSelectOptionsInput } from '@cngx/forms/select';
import { delay, of, throwError } from 'rxjs';
import { createManualState, type ManualAsyncState } from '@cngx/common/data';

@Component({
  selector: 'app-typeahead-typeahead-cngxselectoptionlabel-slot-override',
...
export class TypeaheadTypeaheadCngxselectoptionlabelSlotOverride {
  ...
  protected readonly _exSectionTitle: string = 'Typeahead — *cngxSelectOptionLabel slot override';
  protected readonly _exSubtitle: string = 'Same slot family as CngxSelect — project a custom <code>*cngxSelectOptionLabel</code> template to render avatars / badges / two-line layouts in the typeahead listbox.';
