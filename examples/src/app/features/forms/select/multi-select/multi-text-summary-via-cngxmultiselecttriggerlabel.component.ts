...
// Source: dev-app/src/app/demos/forms/multi-select-demo/multi-select-demo.story.ts#section[4] "Multi — text summary via *cngxMultiSelectTriggerLabel"

import { ChangeDetectionStrategy, Component, signal } from '@angular/core';
import { CngxMultiSelect, CngxMultiSelectTriggerLabel, type CngxSelectCommitAction, type CngxSelectOptionDef, type CngxSelectOptionsInput } from '@cngx/forms/select';
import { delay, of, throwError } from 'rxjs';
import { createManualState, type ManualAsyncState } from '@cngx/common/data';

@Component({
  selector: 'app-multi-select-multi-text-summary-via-cngxmultiselecttriggerlabel',
...
export class MultiSelectMultiTextSummaryViaCngxmultiselecttriggerlabel {
  ...
  protected readonly _exSectionTitle: string = 'Multi — text summary via *cngxMultiSelectTriggerLabel';
  protected readonly _exSubtitle: string = 'Replace the whole chip strip with a plain-text summary by projecting <code>*cngxMultiSelectTriggerLabel</code>. The template context gives you the resolved options, raw values, and count — pick any shape (count badge, comma list, first-label + "+N", …).';
  ...
  protected readonly _exTs: string = `import { CngxMultiSelect, CngxMultiSelectTriggerLabel, type CngxSelectCommitAction, type CngxSelectOptionDef, type CngxSelectOptionsInput } from '@cngx/forms/select';
import { delay, of, throwError } from 'rxjs';
import { createManualState, type ManualAsyncState } from '@cngx/common/data';
