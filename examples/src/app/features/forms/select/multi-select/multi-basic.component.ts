...
// Source: dev-app/src/app/demos/forms/multi-select-demo/multi-select-demo.story.ts#section[0] "Multi — basic"
...
@Component({
  selector: 'app-multi-select-multi-basic',
...
export class MultiSelectMultiBasic {
  ...
  protected readonly _exSectionTitle: string = 'Multi — basic';
  protected readonly _exSubtitle: string = '<code>&lt;cngx-multi-select&gt;</code> with <code>[(values)]</code>. Panel stays open on each toggle (native <code>&lt;select multiple&gt;</code> parity). Disabled options don\'t toggle. Typing while the panel is closed toggles the first matching option.';
