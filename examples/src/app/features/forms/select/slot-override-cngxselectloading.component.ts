...
// Source: dev-app/src/app/demos/forms/select-demo/select-demo.story.ts#section[34] "Slot override: *cngxSelectLoading"
...
@Component({
  selector: 'app-select-slot-override-cngxselectloading',
...
export class SelectSlotOverrideCngxselectloading {
