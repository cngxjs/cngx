...
// Source: dev-app/src/app/demos/forms/select-demo/select-demo.story.ts#section[39] "Slot override: *cngxSelectRetryButton"
...
@Component({
  selector: 'app-select-slot-override-cngxselectretrybutton',
...
export class SelectSlotOverrideCngxselectretrybutton {
