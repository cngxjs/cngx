...
// Source: dev-app/src/app/demos/forms/select-demo/select-demo.story.ts#section[16] "Keyboard: PageUp/PageDown on a long list"
...
@Component({
  selector: 'app-select-keyboard-pageup-pagedown-on-a-long-list',
...
export class SelectKeyboardPageupPagedownOnALongList {
