...
// Source: dev-app/src/app/demos/forms/action-multi-select-demo/action-multi-select-demo.story.ts#section[1] "Pre-seeded + change-event log"
...
@Component({
  selector: 'app-action-multi-select-pre-seeded-change-event-log',
...
export class ActionMultiSelectPreSeededChangeEventLog {
