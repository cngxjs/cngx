...
// Source: dev-app/src/app/demos/forms/action-multi-select-demo/action-multi-select-demo.story.ts#section[2] "Async + error — rollback observation"
...
@Component({
  selector: 'app-action-multi-select-async-error-rollback-observation',
...
export class ActionMultiSelectAsyncErrorRollbackObservation {
