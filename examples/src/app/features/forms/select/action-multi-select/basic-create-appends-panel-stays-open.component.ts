...
// Source: dev-app/src/app/demos/forms/action-multi-select-demo/action-multi-select-demo.story.ts#section[0] "Basic — create appends, panel stays open"
...
@Component({
  selector: 'app-action-multi-select-basic-create-appends-panel-stays-open',
...
export class ActionMultiSelectBasicCreateAppendsPanelStaysOpen {
