...
// Source: dev-app/src/app/demos/forms/action-multi-select-demo/action-multi-select-demo.story.ts#section[3] "Dirty guard — in-panel mini-form"
...
@Component({
  selector: 'app-action-multi-select-dirty-guard-in-panel-mini-form',
...
export class ActionMultiSelectDirtyGuardInPanelMiniForm {
