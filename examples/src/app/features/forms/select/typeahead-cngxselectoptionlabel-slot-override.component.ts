...
// Source: dev-app/src/app/demos/forms/select-demo/select-demo.story.ts#section[44] "Typeahead — *cngxSelectOptionLabel slot override"
...
@Component({
  selector: 'app-select-typeahead-cngxselectoptionlabel-slot-override',
...
export class SelectTypeaheadCngxselectoptionlabelSlotOverride {
