...
// Source: dev-app/src/app/demos/forms/select-demo/select-demo.story.ts#section[14] "Template override: rich trigger label"
...
@Component({
  selector: 'app-select-template-override-rich-trigger-label',
...
export class SelectTemplateOverrideRichTriggerLabel {
