...
// Source: dev-app/src/app/demos/forms/select-demo/select-demo.story.ts#section[19] "Reactive Forms (adaptFormControl)"
...
@Component({
  selector: 'app-select-reactive-forms-adaptformcontrol',
...
export class SelectReactiveFormsAdaptformcontrol {
