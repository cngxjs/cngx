...
// Source: dev-app/src/app/demos/forms/select-demo/select-demo.story.ts#section[31] "Typeahead — single-value async autocomplete"
...
@Component({
  selector: 'app-select-typeahead-single-value-async-autocomplete',
...
export class SelectTypeaheadSingleValueAsyncAutocomplete {
