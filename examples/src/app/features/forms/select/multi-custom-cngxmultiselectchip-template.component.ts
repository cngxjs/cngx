...
// Source: dev-app/src/app/demos/forms/select-demo/select-demo.story.ts#section[25] "Multi — custom *cngxMultiSelectChip template"
...
@Component({
  selector: 'app-select-multi-custom-cngxmultiselectchip-template',
...
export class SelectMultiCustomCngxmultiselectchipTemplate {
