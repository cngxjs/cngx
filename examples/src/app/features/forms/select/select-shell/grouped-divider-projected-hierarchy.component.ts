...
// Source: dev-app/src/app/demos/forms/select-shell-demo/select-shell-demo.story.ts#section[1] "Grouped + divider — projected hierarchy"
...
@Component({
  selector: 'app-select-shell-grouped-divider-projected-hierarchy',
...
export class SelectShellGroupedDividerProjectedHierarchy {
