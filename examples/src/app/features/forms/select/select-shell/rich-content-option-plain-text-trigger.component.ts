...
// Source: dev-app/src/app/demos/forms/select-shell-demo/select-shell-demo.story.ts#section[2] "Rich-content option — plain-text trigger"
...
@Component({
  selector: 'app-select-shell-rich-content-option-plain-text-trigger',
...
export class SelectShellRichContentOptionPlainTextTrigger {
...
protected handleShowcaseChange(e: CngxSelectShellChange<string>): void {
  ...
  protected readonly _exHtml: string = `<cngx-select-shell [label]="'Plan'" [clearable]="true" [(value)]="richValue">
  <cngx-option [value]="'p'"><b>Premium</b> Service</cngx-option>
  <cngx-option [value]="'b'">Basic</cngx-option>
  <cngx-option [value]="'f'">Free</cngx-option>
</cngx-select-shell>`;
