...
// Source: dev-app/src/app/demos/forms/select-demo/select-demo.story.ts#section[45] "Slot override: *cngxComboboxChip"
...
@Component({
  selector: 'app-select-slot-override-cngxcomboboxchip',
...
export class SelectSlotOverrideCngxcomboboxchip {
