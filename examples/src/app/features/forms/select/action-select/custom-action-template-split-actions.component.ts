...
// Source: dev-app/src/app/demos/forms/action-select-demo/action-select-demo.story.ts#section[4] "Custom action template — split actions"
...
@Component({
  selector: 'app-action-select-custom-action-template-split-actions',
      ...
      >
        ...
        >
          <div style="
            ...
            gap: .5rem;
            padding: .5rem .75rem;
            border-bottom: 1px solid var(--cngx-color-border);
          ...
          ">
            ...
            <button
              ...
              (click)="commit()"
              style="padding:.25rem .625rem; border:1px solid var(--cngx-color-border); border-radius:.25rem; background:transparent; cursor:pointer; font:inherit; font-size:.8125rem"
            >
              anlegen
            </button>
            <button
...
export class ActionSelectCustomActionTemplateSplitActions {
