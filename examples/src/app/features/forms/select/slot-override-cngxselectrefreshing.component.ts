...
// Source: dev-app/src/app/demos/forms/select-demo/select-demo.story.ts#section[36] "Slot override: *cngxSelectRefreshing"
...
@Component({
  selector: 'app-select-slot-override-cngxselectrefreshing',
...
export class SelectSlotOverrideCngxselectrefreshing {
