...
// Source: dev-app/src/app/demos/forms/select-demo/select-demo.story.ts#section[1] "⚠ BLOCKER — declarative composition inside <cngx-select>"
...
import { CngxSelect, CngxSelectOption, CngxSelectOptgroup, CngxSelectDivider, type CngxSelectCommitAction, type CngxSelectOptionDef, type CngxSelectOptionsInput } from '@cngx/forms/select';
import { delay, of, throwError } from 'rxjs';
import { createManualState, type ManualAsyncState } from '@cngx/common/data';

@Component({
  selector: 'app-select-blocker-declarative-composition-inside-cngx-select',
...
export class SelectBlockerDeclarativeCompositionInsideCngxSelect {
