...
// Source: dev-app/src/app/demos/forms/select-demo/select-demo.story.ts#section[6] "Loading + empty templates"
...
@Component({
  selector: 'app-select-loading-empty-templates',
...
export class SelectLoadingEmptyTemplates {
