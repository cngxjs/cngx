...
// Source: dev-app/src/app/demos/forms/select-demo/select-demo.story.ts#section[7] "Commit action (async write)"
...
@Component({
  selector: 'app-select-commit-action-async-write',
...
export class SelectCommitActionAsyncWrite {
