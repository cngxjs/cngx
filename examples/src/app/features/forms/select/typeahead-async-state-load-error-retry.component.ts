...
// Source: dev-app/src/app/demos/forms/select-demo/select-demo.story.ts#section[42] "Typeahead — async [state] (load + error + retry)"
...
@Component({
  selector: 'app-select-typeahead-async-state-load-error-retry',
...
export class SelectTypeaheadAsyncStateLoadErrorRetry {
