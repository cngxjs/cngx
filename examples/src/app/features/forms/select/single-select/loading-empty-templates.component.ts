...
// Source: dev-app/src/app/demos/forms/single-select-demo/single-select-demo.story.ts#section[5] "Loading + empty templates"
...
import { CngxSelect, CngxSelectEmpty, type CngxSelectCommitAction, type CngxSelectOptionDef, type CngxSelectOptionsInput } from '@cngx/forms/select';
import { delay, of, throwError } from 'rxjs';
import { createManualState, type ManualAsyncState } from '@cngx/common/data';

@Component({
  selector: 'app-single-select-loading-empty-templates',
...
export class SingleSelectLoadingEmptyTemplates {
  ...
  protected readonly _exSectionTitle: string = 'Loading + empty templates';
  protected readonly _exSubtitle: string = 'Override panel content via <code>*cngxSelectLoading</code> / <code>*cngxSelectEmpty</code>.';
