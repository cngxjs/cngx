...
// Source: dev-app/src/app/demos/forms/single-select-demo/single-select-demo.story.ts#section[14] "Fixed-width panel (number)"
...
@Component({
  selector: 'app-single-select-fixed-width-panel-number',
...
export class SingleSelectFixedWidthPanelNumber {
  ...
  protected readonly _exSectionTitle: string = 'Fixed-width panel (number)';
  protected readonly _exSubtitle: string = '<code>[panelWidth]="400"</code> locks the panel\'s min-inline-size to 400px, independent of the trigger width. <code>\'trigger\'</code> (default) matches trigger width via CSS <code>anchor-size()</code>; <code>null</code> lets the panel size to content.';
