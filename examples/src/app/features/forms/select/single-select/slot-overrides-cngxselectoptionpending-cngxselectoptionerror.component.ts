...
// Source: dev-app/src/app/demos/forms/single-select-demo/single-select-demo.story.ts#section[24] "Slot overrides: *cngxSelectOptionPending + *cngxSelectOptionError"
...
import { CngxSelect, CngxSelectOptionPending, CngxSelectOptionError, type CngxSelectCommitAction, type CngxSelectOptionDef, type CngxSelectOptionsInput } from '@cngx/forms/select';
import { delay, of, throwError } from 'rxjs';
import { createManualState, type ManualAsyncState } from '@cngx/common/data';

@Component({
  selector: 'app-single-select-slot-overrides-cngxselectoptionpending-cngxselectoptionerror',
...
export class SingleSelectSlotOverridesCngxselectoptionpendingCngxselectoptionerror {
  ...
  protected readonly _exSectionTitle: string = 'Slot overrides: *cngxSelectOptionPending + *cngxSelectOptionError';
  protected readonly _exSubtitle: string = 'Per-option-row indicators driven by <code>[commitAction]</code>. Pending shows while the commit is in flight; the error glyph appears on the row that failed (with <code>commitErrorDisplay="inline"</code>).';
