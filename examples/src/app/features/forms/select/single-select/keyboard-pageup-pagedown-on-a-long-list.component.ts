...
// Source: dev-app/src/app/demos/forms/single-select-demo/single-select-demo.story.ts#section[15] "Keyboard: PageUp/PageDown on a long list"
...
@Component({
  selector: 'app-single-select-keyboard-pageup-pagedown-on-a-long-list',
...
export class SingleSelectKeyboardPageupPagedownOnALongList {
  ...
  protected readonly _exSectionTitle: string = 'Keyboard: PageUp/PageDown on a long list';
  protected readonly _exSubtitle: string = 'Open the panel and press <kbd>PageDown</kbd> / <kbd>PageUp</kbd> to jump 10 rows at a time (clamped at boundaries, skipping disabled rows). Typeahead-while-closed still works — focus the trigger and press a letter to commit without opening.';
