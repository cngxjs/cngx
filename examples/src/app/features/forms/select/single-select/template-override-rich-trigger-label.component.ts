...
// Source: dev-app/src/app/demos/forms/single-select-demo/single-select-demo.story.ts#section[13] "Template override: rich trigger label"
...
import { CngxSelect, CngxSelectTriggerLabel, type CngxSelectCommitAction, type CngxSelectOptionDef, type CngxSelectOptionsInput } from '@cngx/forms/select';
import { delay, of, throwError } from 'rxjs';
import { createManualState, type ManualAsyncState } from '@cngx/common/data';

@Component({
  selector: 'app-single-select-template-override-rich-trigger-label',
...
export class SingleSelectTemplateOverrideRichTriggerLabel {
  ...
  protected readonly _exSectionTitle: string = 'Template override: rich trigger label';
  protected readonly _exSubtitle: string = '<code>*cngxSelectTriggerLabel</code> replaces the trigger\'s text node with your own markup — ideal for icons + label combos that mirror the option rendering.';
