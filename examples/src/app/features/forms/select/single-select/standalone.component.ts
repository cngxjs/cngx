...
// Source: dev-app/src/app/demos/forms/single-select-demo/single-select-demo.story.ts#section[0] "Standalone"
...
@Component({
  selector: 'app-single-select-standalone',
...
export class SingleSelectStandalone {
  ...
  protected readonly _exSectionTitle: string = 'Standalone';
  protected readonly _exSubtitle: string = 'Two-way bound via <code>[(value)]</code> — no form-field required.';
