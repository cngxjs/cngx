...
// Source: dev-app/src/app/demos/forms/single-select-demo/single-select-demo.story.ts#section[25] "Slot override: *cngxSelectRetryButton"
...
import { CngxSelect, CngxSelectRetryButton, type CngxSelectCommitAction, type CngxSelectOptionDef, type CngxSelectOptionsInput } from '@cngx/forms/select';
import { delay, of, throwError } from 'rxjs';
import { createManualState, type ManualAsyncState } from '@cngx/common/data';

@Component({
  selector: 'app-single-select-slot-override-cngxselectretrybutton',
...
export class SingleSelectSlotOverrideCngxselectretrybutton {
  ...
  protected readonly _exSectionTitle: string = 'Slot override: *cngxSelectRetryButton';
  protected readonly _exSubtitle: string = 'Swap the visual frame of every Retry / Try again button rendered by the shared panel-shell — load-error, inline refresh-error, and commit-error banner all read from this single override. Context: <code>{ retry, error, disabled, label }</code>.';
