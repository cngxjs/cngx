...
// Source: dev-app/src/app/demos/forms/single-select-demo/single-select-demo.story.ts#section[7] "Commit action (async write)"
...
@Component({
  selector: 'app-single-select-commit-action-async-write',
...
export class SingleSelectCommitActionAsyncWrite {
