...
// Source: dev-app/src/app/demos/forms/single-select-demo/single-select-demo.story.ts#section[18] "Reactive Forms (adaptFormControl)"
...
@Component({
  selector: 'app-single-select-reactive-forms-adaptformcontrol',
...
export class SingleSelectReactiveFormsAdaptformcontrol {
  ...
  protected readonly _exSectionTitle: string = 'Reactive Forms (adaptFormControl)';
  protected readonly _exSubtitle: string = '<code>adaptFormControl</code> wraps the <code>FormControl</code> as a <code>Field&lt;T&gt;</code>.';
