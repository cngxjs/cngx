...
// Source: dev-app/src/app/demos/forms/single-select-demo/single-select-demo.story.ts#section[26] "Slot override: *cngxSelectLoadingGlyph"
...
import { CngxSelect, CngxSelectLoadingGlyph, type CngxSelectCommitAction, type CngxSelectOptionDef, type CngxSelectOptionsInput } from '@cngx/forms/select';
import { delay, of, throwError } from 'rxjs';
import { createManualState, type ManualAsyncState } from '@cngx/common/data';

@Component({
  selector: 'app-single-select-slot-override-cngxselectloadingglyph',
...
export class SingleSelectSlotOverrideCngxselectloadingglyph {
  ...
  protected readonly _exSectionTitle: string = 'Slot override: *cngxSelectLoadingGlyph';
  protected readonly _exSubtitle: string = 'Replace the inner CSS-driven glyph of the spinner / bar / dots loading variants while keeping the shell\'s ARIA wiring (<code>role="status"</code>, <code>aria-live</code>, <code>aria-label</code>). Skeleton variant ignores this slot — its rows are layout, not glyph.';
