...
// Source: dev-app/src/app/demos/forms/single-select-demo/single-select-demo.story.ts#section[9] "Refreshing variants"
...
@Component({
  selector: 'app-single-select-refreshing-variants',
...
export class SingleSelectRefreshingVariants {
  ...
  protected readonly _exSectionTitle: string = 'Refreshing variants';
  protected readonly _exSubtitle: string = '<code>[refreshingVariant]</code> controls the subsequent-load indicator when options stay visible: <code>bar</code> (default), <code>spinner</code>, <code>dots</code>, or <code>none</code>. Triggered by <code>state.status() === \'refreshing\'</code>.';
