...
// Source: dev-app/src/app/demos/forms/single-select-demo/single-select-demo.story.ts#section[20] "Slot override: *cngxSelectLoading"
...
import { CngxSelect, CngxSelectLoading, type CngxSelectCommitAction, type CngxSelectOptionDef, type CngxSelectOptionsInput } from '@cngx/forms/select';
import { delay, of, throwError } from 'rxjs';
import { createManualState, type ManualAsyncState } from '@cngx/common/data';

@Component({
  selector: 'app-single-select-slot-override-cngxselectloading',
...
export class SingleSelectSlotOverrideCngxselectloading {
  ...
  protected readonly _exSectionTitle: string = 'Slot override: *cngxSelectLoading';
  protected readonly _exSubtitle: string = 'Replace the panel-shell\'s default loading indicator with a consumer-authored body — useful for branded spinners, progress text, or a cancel-and-restart affordance.';
