...
// Source: dev-app/src/app/demos/forms/single-select-demo/single-select-demo.story.ts#section[4] "Rich option rendering"
...
import { CngxSelect, CngxSelectOptionLabel, type CngxSelectCommitAction, type CngxSelectOptionDef, type CngxSelectOptionsInput } from '@cngx/forms/select';
import { delay, of, throwError } from 'rxjs';
import { createManualState, type ManualAsyncState } from '@cngx/common/data';

@Component({
  selector: 'app-single-select-rich-option-rendering',
...
export class SingleSelectRichOptionRendering {
  ...
  protected readonly _exSectionTitle: string = 'Rich option rendering';
  protected readonly _exSubtitle: string = 'Project a <code>*cngxSelectOptionLabel</code> template to render icons/badges per option.';
