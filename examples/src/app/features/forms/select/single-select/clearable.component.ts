...
// Source: dev-app/src/app/demos/forms/single-select-demo/single-select-demo.story.ts#section[3] "Clearable"
...
export class SingleSelectClearable {
  ...
  protected readonly _exSectionTitle: string = 'Clearable';
  protected readonly _exSubtitle: string = '<code>[clearable]="true"</code> adds a ✕ button when a value is selected.';
