...
// Source: dev-app/src/app/demos/forms/single-select-demo/single-select-demo.story.ts#section[21] "Slot override: *cngxSelectOptgroup"
...
import { CngxSelect, CngxSelectOptgroupTemplate, type CngxSelectCommitAction, type CngxSelectOptionDef, type CngxSelectOptionsInput } from '@cngx/forms/select';
import { delay, of, throwError } from 'rxjs';
import { createManualState, type ManualAsyncState } from '@cngx/common/data';

@Component({
  selector: 'app-single-select-slot-override-cngxselectoptgroup',
...
export class SingleSelectSlotOverrideCngxselectoptgroup {
  ...
  protected readonly _exSectionTitle: string = 'Slot override: *cngxSelectOptgroup';
  protected readonly _exSubtitle: string = 'Re-skin grouped-option labels — render badges, icons, or counts in the optgroup header without touching the option rows themselves. Class name <code>CngxSelectOptgroupTemplate</code> distinguishes this directive from the <code>&lt;cngx-optgroup&gt;</code> element component used in declarative composition.';
