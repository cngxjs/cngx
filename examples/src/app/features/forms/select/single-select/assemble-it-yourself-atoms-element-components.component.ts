...
// Source: dev-app/src/app/demos/forms/single-select-demo/single-select-demo.story.ts#section[1] "Assemble it yourself — atoms + element components"
...
import { CngxSelectOption, CngxSelectOptgroup, CngxSelectDivider, type CngxSelectCommitAction, type CngxSelectOptionDef, type CngxSelectOptionsInput } from '@cngx/forms/select';
...
@Component({
  selector: 'app-single-select-assemble-it-yourself-atoms-element-components',
...
export class SingleSelectAssembleItYourselfAtomsElementComponents {
...
protected readonly assembledValue = signal<string | undefined>(undefined);`;
  protected readonly _exHtml: string = `<button type="button"
        class="chip"
        [cngxPopoverTrigger]="myPop"
        [haspopup]="'listbox'"
        [cngxListboxTrigger]="myLb"
