...
// Source: dev-app/src/app/demos/forms/single-select-demo/single-select-demo.story.ts#section[22] "Slot override: *cngxSelectRefreshing"
...
import { CngxSelect, CngxSelectRefreshing, type CngxSelectCommitAction, type CngxSelectOptionDef, type CngxSelectOptionsInput } from '@cngx/forms/select';
import { delay, of, throwError } from 'rxjs';
import { createManualState, type ManualAsyncState } from '@cngx/common/data';

@Component({
  selector: 'app-single-select-slot-override-cngxselectrefreshing',
...
export class SingleSelectSlotOverrideCngxselectrefreshing {
  ...
  protected readonly _exSectionTitle: string = 'Slot override: *cngxSelectRefreshing';
  protected readonly _exSubtitle: string = 'Replace the default 2px progress bar overlaid on stale options. Override receives <code>previousCount</code> so consumer templates can render context-aware status like <em>"Refreshing 4 items"</em>.';
