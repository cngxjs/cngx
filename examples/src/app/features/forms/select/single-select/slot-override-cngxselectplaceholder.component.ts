...
// Source: dev-app/src/app/demos/forms/single-select-demo/single-select-demo.story.ts#section[19] "Slot override: *cngxSelectPlaceholder"
...
import { CngxSelect, CngxSelectPlaceholder, type CngxSelectCommitAction, type CngxSelectOptionDef, type CngxSelectOptionsInput } from '@cngx/forms/select';
import { delay, of, throwError } from 'rxjs';
import { createManualState, type ManualAsyncState } from '@cngx/common/data';

@Component({
  selector: 'app-single-select-slot-override-cngxselectplaceholder',
...
export class SingleSelectSlotOverrideCngxselectplaceholder {
  ...
  protected readonly _exSectionTitle: string = 'Slot override: *cngxSelectPlaceholder';
  protected readonly _exSubtitle: string = 'Replace the plain placeholder string with custom markup — render an icon + the placeholder text, a stylised hint, or a help link inside the trigger.';
