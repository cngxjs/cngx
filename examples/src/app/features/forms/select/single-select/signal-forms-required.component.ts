...
// Source: dev-app/src/app/demos/forms/single-select-demo/single-select-demo.story.ts#section[17] "Signal Forms (required)"
...
@Component({
  selector: 'app-single-select-signal-forms-required',
...
export class SingleSelectSignalFormsRequired {
  ...
  protected readonly _exSectionTitle: string = 'Signal Forms (required)';
  protected readonly _exSubtitle: string = 'Drop <code>&lt;cngx-select&gt;</code> into <code>&lt;cngx-form-field&gt;</code>. Everything flows automatically.';
