...
// Source: dev-app/src/app/demos/forms/single-select-demo/single-select-demo.story.ts#section[12] "Selection indicator variant: radio"
...
@Component({
  selector: 'app-single-select-selection-indicator-variant-radio',
...
export class SingleSelectSelectionIndicatorVariantRadio {
  ...
  protected readonly _exSectionTitle: string = 'Selection indicator variant: radio';
  protected readonly _exSubtitle: string = '<code>[selectionIndicatorVariant]="\'radio\'"</code> swaps the panel\'s built-in indicator from the checkmark to <code>cngx-radio-indicator</code> (dot-in-circle). Useful for single-select panels that want a radio-style visual without losing dropdown ergonomics. Set globally via <code>provideSelectConfig(withSelectionIndicatorVariant(\'radio\'))</code>.';
