...
// Source: dev-app/src/app/demos/forms/single-select-demo/single-select-demo.story.ts#section[10] "Template override: custom caret"
...
import { CngxSelect, CngxSelectCaret, type CngxSelectCommitAction, type CngxSelectOptionDef, type CngxSelectOptionsInput } from '@cngx/forms/select';
import { delay, of, throwError } from 'rxjs';
import { createManualState, type ManualAsyncState } from '@cngx/common/data';

@Component({
  selector: 'app-single-select-template-override-custom-caret',
...
export class SingleSelectTemplateOverrideCustomCaret {
  ...
  protected readonly _exSectionTitle: string = 'Template override: custom caret';
  protected readonly _exSubtitle: string = 'Project a <code>*cngxSelectCaret</code> template — the default ▾ glyph gets replaced with any markup you want, with <code>let-open="open"</code> available for rotation state.';
