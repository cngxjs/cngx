...
// Source: dev-app/src/app/demos/forms/single-select-demo/single-select-demo.story.ts#section[8] "Loading variants"
...
@Component({
  selector: 'app-single-select-loading-variants',
...
export class SingleSelectLoadingVariants {
  ...
  protected readonly _exSectionTitle: string = 'Loading variants';
  protected readonly _exSubtitle: string = '<code>[loadingVariant]</code> picks one of four built-in first-load visuals: <code>spinner</code> (default), <code>skeleton</code> (with configurable <code>[skeletonRowCount]</code>), <code>bar</code>, or <code>text</code>. Globally configurable via <code>provideSelectConfig(withLoadingVariant(\'skeleton\'), withSkeletonRowCount(5))</code>.';
