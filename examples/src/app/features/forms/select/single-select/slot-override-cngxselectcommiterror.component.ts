...
// Source: dev-app/src/app/demos/forms/single-select-demo/single-select-demo.story.ts#section[23] "Slot override: *cngxSelectCommitError"
...
@Component({
  selector: 'app-single-select-slot-override-cngxselectcommiterror',
...
export class SingleSelectSlotOverrideCngxselectcommiterror {
