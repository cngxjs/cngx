...
// Source: dev-app/src/app/demos/forms/single-select-demo/single-select-demo.story.ts#section[6] "Async state consumer"
...
import { CngxSelect, CngxSelectError, type CngxSelectCommitAction, type CngxSelectOptionDef, type CngxSelectOptionsInput } from '@cngx/forms/select';
import { delay, of, throwError } from 'rxjs';
import { createManualState, type ManualAsyncState } from '@cngx/common/data';

@Component({
  selector: 'app-single-select-async-state-consumer',
...
export class SingleSelectAsyncStateConsumer {
  ...
  protected readonly _exSectionTitle: string = 'Async state consumer';
  protected readonly _exSubtitle: string = '<code>[state]</code> drives the panel via <code>CngxAsyncState</code>: loading → skeleton, success → options, empty → empty template, refreshing → top-bar + options, error → retry panel. Replaces <code>[options]</code> while the state has data.';
