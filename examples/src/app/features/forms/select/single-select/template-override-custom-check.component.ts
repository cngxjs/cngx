...
// Source: dev-app/src/app/demos/forms/single-select-demo/single-select-demo.story.ts#section[11] "Template override: custom check"
...
import { CngxSelect, CngxSelectCheck, type CngxSelectCommitAction, type CngxSelectOptionDef, type CngxSelectOptionsInput } from '@cngx/forms/select';
import { delay, of, throwError } from 'rxjs';
import { createManualState, type ManualAsyncState } from '@cngx/common/data';

@Component({
  selector: 'app-single-select-template-override-custom-check',
...
export class SingleSelectTemplateOverrideCustomCheck {
  ...
  protected readonly _exSectionTitle: string = 'Template override: custom check';
  protected readonly _exSubtitle: string = 'Project <code>*cngxSelectCheck</code> to replace the ✓ glyph shown on the selected row. Context: <code>let-option</code>, <code>let-selected="selected"</code>.';
