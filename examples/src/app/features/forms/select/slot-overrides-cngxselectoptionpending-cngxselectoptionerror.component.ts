...
// Source: dev-app/src/app/demos/forms/select-demo/select-demo.story.ts#section[38] "Slot overrides: *cngxSelectOptionPending + *cngxSelectOptionError"
...
@Component({
  selector: 'app-select-slot-overrides-cngxselectoptionpending-cngxselectoptionerror',
...
export class SelectSlotOverridesCngxselectoptionpendingCngxselectoptionerror {
