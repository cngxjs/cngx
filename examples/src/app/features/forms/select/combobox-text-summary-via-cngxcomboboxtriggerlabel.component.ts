...
// Source: dev-app/src/app/demos/forms/select-demo/select-demo.story.ts#section[30] "Combobox — text summary via *cngxComboboxTriggerLabel"
...
@Component({
  selector: 'app-select-combobox-text-summary-via-cngxcomboboxtriggerlabel',
...
export class SelectComboboxTextSummaryViaCngxcomboboxtriggerlabel {
