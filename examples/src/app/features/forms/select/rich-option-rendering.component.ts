...
// Source: dev-app/src/app/demos/forms/select-demo/select-demo.story.ts#section[5] "Rich option rendering"
...
@Component({
  selector: 'app-select-rich-option-rendering',
...
export class SelectRichOptionRendering {
