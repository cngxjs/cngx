...
// Source: dev-app/src/app/demos/forms/select-demo/select-demo.story.ts#section[12] "Template override: custom check"
...
@Component({
  selector: 'app-select-template-override-custom-check',
...
export class SelectTemplateOverrideCustomCheck {
