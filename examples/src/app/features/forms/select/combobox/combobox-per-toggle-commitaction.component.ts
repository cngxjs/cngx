...
// Source: dev-app/src/app/demos/forms/combobox-demo/combobox-demo.story.ts#section[2] "Combobox — per-toggle [commitAction]"
...
@Component({
  selector: 'app-combobox-combobox-per-toggle-commitaction',
...
export class ComboboxComboboxPerToggleCommitaction {
  ...
  protected readonly _exSectionTitle: string = 'Combobox — per-toggle [commitAction]';
  protected readonly _exSubtitle: string = 'Every toggle (option click, chip ×, Backspace-on-empty, clear-all) routes through an async write with optimistic/pessimistic supersede semantics — same wiring as the multi-select producer.';
