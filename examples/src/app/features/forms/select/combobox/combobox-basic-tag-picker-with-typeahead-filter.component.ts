...
// Source: dev-app/src/app/demos/forms/combobox-demo/combobox-demo.story.ts#section[0] "Combobox — basic (tag picker with typeahead filter)"

import { ChangeDetectionStrategy, Component, signal } from '@angular/core';
import { CngxCombobox, type CngxSelectCommitAction, type CngxSelectOptionDef, type CngxSelectOptionsInput } from '@cngx/forms/select';
import { delay, of, throwError } from 'rxjs';
import { createManualState, type ManualAsyncState } from '@cngx/common/data';

@Component({
  selector: 'app-combobox-combobox-basic-tag-picker-with-typeahead-filter',
...
export class ComboboxComboboxBasicTagPickerWithTypeaheadFilter {
  ...
  protected readonly _exSectionTitle: string = 'Combobox — basic (tag picker with typeahead filter)';
  protected readonly _exSubtitle: string = '<code>&lt;cngx-combobox&gt;</code> — inline <code>&lt;input role="combobox"&gt;</code> next to the chip strip. Typing filters the panel live; Backspace on an empty input removes the trailing chip; panel stays open on each pick (<code>closeOnSelect</code> default <code>false</code>).';
  ...
  protected readonly _exTs: string = `import { CngxCombobox, type CngxSelectCommitAction, type CngxSelectOptionDef, type CngxSelectOptionsInput } from '@cngx/forms/select';
import { delay, of, throwError } from 'rxjs';
import { createManualState, type ManualAsyncState } from '@cngx/common/data';
