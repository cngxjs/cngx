...
// Source: dev-app/src/app/demos/forms/combobox-demo/combobox-demo.story.ts#section[3] "Combobox — clearable + custom *cngxSelectClearButton"

import { ChangeDetectionStrategy, Component, signal } from '@angular/core';
import { CngxSelectClearButton, CngxCombobox, type CngxSelectCommitAction, type CngxSelectOptionDef, type CngxSelectOptionsInput } from '@cngx/forms/select';
import { delay, of, throwError } from 'rxjs';
import { createManualState, type ManualAsyncState } from '@cngx/common/data';

@Component({
  selector: 'app-combobox-combobox-clearable-custom-cngxselectclearbutton',
...
export class ComboboxComboboxClearableCustomCngxselectclearbutton {
  ...
  protected readonly _exSectionTitle: string = 'Combobox — clearable + custom *cngxSelectClearButton';
  protected readonly _exSubtitle: string = 'Reuse the shared <code>*cngxSelectClearButton</code> slot to swap the default ✕ for any consumer-authored trigger. Same slot works on <code>CngxSelect</code> and <code>CngxMultiSelect</code>.';
  ...
  protected readonly _exTs: string = `import { CngxSelectClearButton, CngxCombobox, type CngxSelectCommitAction, type CngxSelectOptionDef, type CngxSelectOptionsInput } from '@cngx/forms/select';
import { delay, of, throwError } from 'rxjs';
import { createManualState, type ManualAsyncState } from '@cngx/common/data';
