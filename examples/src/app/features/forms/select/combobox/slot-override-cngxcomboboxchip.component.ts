...
// Source: dev-app/src/app/demos/forms/combobox-demo/combobox-demo.story.ts#section[5] "Slot override: *cngxComboboxChip"

import { ChangeDetectionStrategy, Component, signal } from '@angular/core';
import { CngxCombobox, CngxComboboxChip, type CngxSelectCommitAction, type CngxSelectOptionDef, type CngxSelectOptionsInput } from '@cngx/forms/select';
import { delay, of, throwError } from 'rxjs';
import { createManualState, type ManualAsyncState } from '@cngx/common/data';

@Component({
  selector: 'app-combobox-slot-override-cngxcomboboxchip',
...
export class ComboboxSlotOverrideCngxcomboboxchip {
  ...
  protected readonly _exSectionTitle: string = 'Slot override: *cngxComboboxChip';
  protected readonly _exSubtitle: string = 'Per-chip override for the combobox\'s tag strip — same context shape as <code>*cngxMultiSelectChip</code> (<code>{ option, remove, index }</code>), so a consumer-authored chip template can be projected into either variant unchanged.';
  ...
  protected readonly _exTs: string = `import { CngxCombobox, CngxComboboxChip, type CngxSelectCommitAction, type CngxSelectOptionDef, type CngxSelectOptionsInput } from '@cngx/forms/select';
import { delay, of, throwError } from 'rxjs';
import { createManualState, type ManualAsyncState } from '@cngx/common/data';
