...
// Source: dev-app/src/app/demos/forms/select-demo/select-demo.story.ts#section[10] "Refreshing variants"
...
@Component({
  selector: 'app-select-refreshing-variants',
...
export class SelectRefreshingVariants {
