...
// Source: dev-app/src/app/demos/forms/select-demo/select-demo.story.ts#section[41] "commitErrorDisplay variants — banner / inline / none"
...
@Component({
  selector: 'app-select-commiterrordisplay-variants-banner-inline-none',
...
export class SelectCommiterrordisplayVariantsBannerInlineNone {
