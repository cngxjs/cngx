...
// Source: dev-app/src/app/demos/forms/select-demo/select-demo.story.ts#section[20] "Multi — basic"
...
@Component({
  selector: 'app-select-multi-basic',
