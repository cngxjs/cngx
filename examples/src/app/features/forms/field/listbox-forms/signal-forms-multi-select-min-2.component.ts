...
// Source: dev-app/src/app/demos/forms/listbox-forms-demo/listbox-forms-demo.story.ts#section[1] "Signal Forms — multi select (min 2)"
...
@Component({
  selector: 'app-listbox-forms-signal-forms-multi-select-min-2',
...
export class ListboxFormsSignalFormsMultiSelectMin2 {
  ...
  protected readonly _exSectionTitle: string = 'Signal Forms — multi select (min 2)';
  protected readonly _exSubtitle: string = 'Multi-select mit <code>minLength</code> validator. Selection pushed into field array.';
