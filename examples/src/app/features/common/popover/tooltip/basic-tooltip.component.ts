...
// Source: dev-app/src/app/demos/common/popover/tooltip-demo/tooltip-demo.story.ts#section[0] "Basic Tooltip"

import { ChangeDetectionStrategy, Component } from '@angular/core';
import { CngxTooltip } from '@cngx/common/popover';

@Component({
  selector: 'app-tooltip-basic-tooltip',
...
export class TooltipBasicTooltip {
