...
// Source: examples/stories/common/interactive/chip-interaction-demo/chip-interaction-demo.story.ts#section[1] "Removable with (removeRequest) on Backspace / Delete"
