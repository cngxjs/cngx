...
// Source: dev-app/src/app/demos/common/interactive/chip-interaction-demo/chip-interaction-demo.story.ts#section[2] "Disabled state"
...
@Component({
  selector: 'app-chip-interaction-disabled-state',
...
export class ChipInteractionDisabledState {
