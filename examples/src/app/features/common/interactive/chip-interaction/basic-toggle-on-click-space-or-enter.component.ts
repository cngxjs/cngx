...
// Source: dev-app/src/app/demos/common/interactive/chip-interaction-demo/chip-interaction-demo.story.ts#section[0] "Basic — toggle on click, Space, or Enter"
...
export class ChipInteractionBasicToggleOnClickSpaceOrEnter {
  ...
  protected readonly _exUses: readonly string[] = ['CngxChipInteraction', 'CngxChip', 'CNGX_CONTROL_VALUE'];
