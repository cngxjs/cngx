...
// Source: examples/stories/common/interactive/button-multi-toggle-group-demo/button-multi-toggle-group-demo.story.ts#section[1] "Disabled — group cascade vs per-toggle"
