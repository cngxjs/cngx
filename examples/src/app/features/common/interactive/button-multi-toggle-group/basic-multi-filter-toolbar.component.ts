...
// Source: examples/stories/common/interactive/button-multi-toggle-group-demo/button-multi-toggle-group-demo.story.ts#section[0] "Basic — multi-filter toolbar"
