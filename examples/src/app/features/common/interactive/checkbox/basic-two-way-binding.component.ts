...
// Source: dev-app/src/app/demos/common/interactive/checkbox-demo/checkbox-demo.story.ts#section[0] "Basic — two-way binding"

import { ChangeDetectionStrategy, Component, computed, signal } from '@angular/core';
import { CngxCheckbox } from '@cngx/common/interactive';

@Component({
  selector: 'app-checkbox-basic-two-way-binding',
...
export class CheckboxBasicTwoWayBinding {
  ...
  protected readonly _exSubtitle: string = 'Click the box or focus + press <strong>Space</strong>/<strong>Enter</strong>.';
  protected readonly _exTags: readonly { dim: string; value: string }[] = [];
  protected readonly _exUses: readonly string[] = ['CngxCheckbox'];
