...
// Source: examples/stories/common/interactive/error-aggregator-demo/error-aggregator-demo.story.ts#section[1] "cngx-card host (no scope — errors visible immediately)"
