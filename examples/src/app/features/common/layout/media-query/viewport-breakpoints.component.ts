...
// Source: dev-app/src/app/demos/common/layout/media-query-demo/media-query-demo.story.ts#section[0] "CngxMediaQuery — Viewport Breakpoints"
...
export class MediaQueryViewportBreakpoints {
  ...
  protected readonly _exUses: readonly string[] = ['CngxMediaQuery'];
