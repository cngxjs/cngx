...
// Source: dev-app/src/app/demos/common/display/icon-demo/icon-demo.story.ts#section[1] "Decorative vs informative"
...
export class IconDecorativeVsInformative {
  ...
  protected readonly _exUses: readonly string[] = ['CngxIcon'];
