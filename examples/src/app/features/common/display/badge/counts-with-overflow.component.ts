...
// Source: dev-app/src/app/demos/common/display/badge-demo/badge-demo.story.ts#section[0] "Counts with overflow"

import { ChangeDetectionStrategy, Component } from '@angular/core';
import { CngxBadge } from '@cngx/common/display';

@Component({
  selector: 'app-badge-counts-with-overflow',
...
export class BadgeCountsWithOverflow {
