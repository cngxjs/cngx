...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'filter-builder-form-field',
        loadComponent: () =>
          import('./demos/forms/filter-builder-form-field-demo/filter-builder-form-field-demo.component').then((m) => m.FilterBuilderFormFieldDemoComponent),
      },
      {
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'tabs/tab-slot-overrides',
        loadComponent: () =>
          import('./demos/ui/tabs/tab-slot-overrides-demo/tab-slot-overrides-demo.component').then((m) => m.TabSlotOverridesDemoComponent),
      },
