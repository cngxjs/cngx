...
@Component({
  ...
  template: `
    <app-doc-shell title="Material Integration"
      description="Use any Angular Material form control inside cngx-form-field via the universal CngxBindField directive."
      overview="<p><code>[cngxBindField]</code> is the universal bridge from any control — Material, native HTML, or a custom component — to <code>&lt;cngx-form-field&gt;</code>. Place it on the same element as the Material control; cngx derives <code>id</code>, <code>aria-*</code>, <code>empty</code>, <code>focused</code>, <code>disabled</code>, and <code>errorState</code> purely from the bound <code>Field</code> via the presenter.</p><p>Value-flow goes through the control's own bindings — <code>[control]</code> (Signal Forms) or <code>[formControl]</code> (Reactive Forms). cngx never touches the value layer.</p><p>An optional Material theme mixin (<code>@cngx/themes/material/field-theme</code>) maps M3/M2 design tokens to cngx-form-field CSS custom properties.</p>"
      [apiComponents]="['CngxBindField']">
      <app-example-card title="matInput via CngxBindField"
        [subtitle]="_s0"
  ...
  <div class="demo-form">
    ...
    <div class="status-row">
      ...
      <app-example-card title="mat-select via CngxBindField + Reactive Forms"
        [subtitle]="_s1"
...
export class MaterialDemoComponent {
  protected readonly _s0 = '<code>mat-form-field</code> provides the Material input chrome. <code>cngx-form-field</code> provides the A11y coordination. Add <code>cngxBindField</code> on the same element as <code>matInput</code>.';
  protected readonly _s1 = 'Same directive, different Material control and a Reactive-Forms value source. <code>adaptFormControl</code> wraps the <code>FormControl</code> as a <code>Field&lt;T&gt;</code> for <code>cngx-form-field</code>; <code>[formControl]</code> on the <code>mat-select</code> handles value-flow.';
