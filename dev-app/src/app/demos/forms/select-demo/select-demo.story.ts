...
export const STORY: DemoSpec = {
  ...
  <div class="event-grid" style="margin-top:12px">
    ...
    },
    {
      title: 'Multi — basic',
      subtitle:
        '<code>&lt;cngx-multi-select&gt;</code> with <code>[(values)]</code>. Panel stays open on each toggle (native <code>&lt;select multiple&gt;</code> parity). Disabled options don\'t toggle. Typing while the panel is closed toggles the first matching option.',
  ...
  <div class="event-grid" style="margin-top:12px">
    ...
    },
    {
      ...
      subtitle:
        '<code>[clearable]="true"</code> exposes a single ✕ next to the caret that empties the whole selection in one click. The per-chip ✕ on every pill stays independent of this flag.',
      imports: ['CngxMultiSelect'],
      template: `
  <cngx-multi-select
    [label]="'Themen'"
  ...
  <div class="event-grid" style="margin-top:12px">
    ...
    },
    {
      ...
      subtitle:
        'Same async-state protocol as the single variant. The panel renders skeleton / empty / error / refreshing states from the bound <code>CngxAsyncState</code>; the trigger chip list stays derived from the resolved data.',
      imports: ['CngxMultiSelect'],
      template: `
  <cngx-multi-select
    [label]="'Themen'"
  ...
  <div class="event-grid" style="margin-top:12px">
    ...
    },
    {
      ...
      subtitle:
        'Each toggle routes through an async write. <code>optimistic</code> (default) updates <code>values()</code> immediately and rolls back on error; <code>pessimistic</code> defers the write until success and surfaces a spinner on the toggled option. Consecutive toggles supersede any in-flight commit.',
      imports: ['CngxMultiSelect'],
      template: `
  ...
  <div class="event-grid" style="margin-top:12px">
    ...
    },
    {
      ...
      subtitle:
        'Replace the default <code>&lt;cngx-chip&gt;</code> pill per instance with any content. The template context gives you the full option plus a commit-aware <code>remove</code> callback.',
