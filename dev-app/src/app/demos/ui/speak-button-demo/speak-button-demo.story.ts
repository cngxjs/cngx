...
export const STORY: DemoSpec = {
  ...
  sections: [
    {
      ...
      subtitle:
        '<code>&lt;cngx-speak-button&gt;</code> connects to a <code>CngxSpeak</code> directive via ' +
        '<code>[speakRef]</code>. It renders a speaker icon with wave animation while speaking. ' +
        'Fully themeable via <code>--cngx-speak-btn-*</code> CSS custom properties.',
  ...
  <div class="event-grid" style="margin-top: 12px">
    ...
    },
    {
      ...
      subtitle:
        'Override <code>--cngx-speak-btn-*</code> variables on a parent element to customize ' +
        'size, color, radius, and animation. Each block below shows a different style.',
      imports: ['CngxSpeak', 'CngxSpeakButton'],
      template: `
...
{{ '}' }}</code></pre>
  ...
  <pre class="code-block" style="margin-top: 8px; font-size: 0.75rem;"><code>&lt;cngx-speak-button class="round" [speakRef]="tts" /&gt;</code></pre>`,
    },
    {
      ...
      subtitle:
        '<code>CngxSpeakButton</code> ships a Material theme SCSS mixin that maps ' +
        '<code>--mat-sys-*</code> tokens to the button CSS variables. ' +
        'Alternatively, skip <code>CngxSpeakButton</code> entirely and use a ' +
        '<code>mat-icon-button</code> with the headless <code>CngxSpeak</code> directive.',
