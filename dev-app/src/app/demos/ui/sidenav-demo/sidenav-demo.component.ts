...
export class SidenavDemoComponent {
  protected readonly _s0 = 'A single <code>cngx-sidenav</code> with mode control. <strong>side</strong> = permanent, <strong>push</strong> = pushes content, <strong>over</strong> = overlays.';
  protected readonly _s1 = 'Two sidenavs in the same layout. The left sidebar is permanent (<code>mode="side"</code>), the right is an overlay panel that opens on demand.';
  protected readonly _s2 = 'The organism composes drawer, backdrop, scroll lock, and media query atoms. The consumer only needs the declarative template.';
