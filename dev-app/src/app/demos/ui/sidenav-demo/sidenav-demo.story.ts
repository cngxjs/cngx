...
export const STORY: DemoSpec = {
  ...
  <div class="status-row" style="margin-top: 0.5rem;">
    ...
    },
    {
      ...
      subtitle:
        '<code>sidenav-theme.scss</code> follows the same structure as Angular Material: ' +
        '<code>base()</code> for structural tokens, <code>color()</code> for M3/M2 palette colors, ' +
        '<code>density()</code> for spacing. All values are CSS custom properties that consumers can override.',
      template: `
