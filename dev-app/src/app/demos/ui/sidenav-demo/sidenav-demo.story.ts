...
export const STORY: DemoSpec = {
  ...
  <div class="status-row" style="margin-top: 0.5rem;">
    ...
    },
    {
      ...
      subtitle:
        'Side-by-side comparison using only CSS custom property overrides. ' +
        'The left panel uses default M3 light tokens from <code>sidenav-theme.scss</code>. ' +
        'The right panel overrides <code>--cngx-sidenav-*</code> variables inline for a dark appearance. ' +
        'No class changes, no separate theme file -- just CSS custom properties.',
