...
// Source: demos/ui/mat-stepper/mat-stepper-instrumentation-demo/mat-stepper-instrumentation-demo.story.ts
...
@Component({
  selector: 'app-mat-stepper-instrumentation-demo',
  standalone: true,
...
export class MatStepperInstrumentationDemoComponent {
  protected readonly _s0 = 'The <code>&lt;mat-stepper&gt;</code> stays unchanged — <code>cngxMatStepper</code> is the only addition. The commit lifecycle, the <code>CNGX_STATEFUL</code> producer, and the toast + banner bridges work identically to <code>&lt;cngx-stepper&gt;</code>. Toggle the mode and "simulate error" to exercise the four quadrants.';
