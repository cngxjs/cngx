...
export const STORY: DemoSpec = {
  ...
  sections: [
    {
      title: 'Vanilla <mat-stepper> upgraded by adding cngxMatStepper',
      subtitle:
        'The <code>&lt;mat-stepper&gt;</code> stays unchanged — <code>cngxMatStepper</code> is the only addition. The commit lifecycle, the <code>CNGX_STATEFUL</code> producer, and the toast + banner bridges work identically to <code>&lt;cngx-stepper&gt;</code>. Toggle the mode and "simulate error" to exercise the four quadrants.',
      imports: [
        'MatStepperModule',
