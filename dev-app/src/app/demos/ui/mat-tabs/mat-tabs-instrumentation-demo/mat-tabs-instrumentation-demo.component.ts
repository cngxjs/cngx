...
@Component({
  ...
  template: `
    <app-doc-shell title="Mat-tabs — instrumentation directive"
      ...
      [apiComponents]="['CngxMatTabs', 'CngxMatTabError', 'CngxMatTabAggregatorContent', 'CngxMatTabRejectionContent', 'CngxToastOn', 'CngxBannerOn']">
  ...
  <div class="event-grid" style="margin-top:12px">
    <div class="event-row"><span class="event-label">Active overflow tab</span><span class="event-value">{{ overflowActive() }}</span></div>
      ...
      <app-example-card title="Custom rejection descriptor via <code>*cngxMatTabRejectionContent</code>"
        [subtitle]="_s3"
...
import { CngxBanner, CngxToaster, CngxToastOn, CngxBannerOn } from '@cngx/ui/feedback';
  ...
  protected readonly _srcTs3 = `import { toSignal } from '@angular/core/rxjs-interop';
import { FormControl, FormGroup, ReactiveFormsModule, Validators } from '@angular/forms';
import { Observable } from 'rxjs';
import { startWith } from 'rxjs/operators';
import { MatTabsModule } from '@angular/material/tabs';
