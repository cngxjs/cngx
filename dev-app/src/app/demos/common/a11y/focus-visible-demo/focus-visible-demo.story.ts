...
export const STORY: DemoSpec = {
  ...
  sections: [
    {
      ...
      subtitle:
        '<code>[cngxFocusVisible]</code> adds the <code>cngx-focus-visible</code> class ' +
        'when the element receives keyboard focus. Mouse/touch focus does not add the class. ' +
        'Unlike native <code>:focus-visible</code>, the signal is available in TypeScript for ' +
        'conditional logic beyond CSS.',
  ...
  <div class="event-grid" style="margin-top: 12px">
    ...
    },
    {
      ...
      subtitle:
        'Apply <code>[cngxFocusVisible]</code> to form elements to show a ' +
        'focus ring only for keyboard users. Mouse-clicking an input focuses it ' +
        'but does not trigger the ring — reducing visual noise for pointer users.',
      imports: ['CngxFocusVisible'],
      template: `
