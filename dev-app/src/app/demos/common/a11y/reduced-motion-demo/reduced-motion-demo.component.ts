...
export class ReducedMotionDemoComponent {
  ...
  protected readonly _srcTs0 = `protected notifications = signal<{ id: number; text: string }[]>([]);
  private _nextId = 0;
  ...
  protected readonly _srcHtml1 = `<div cngxReducedMotion #rm2="cngxReducedMotion">
    <button class="sort-btn" (click)="addNotification()">
      Add notification
    </button>
  ...
  protected readonly _srcTs1 = `protected notifications = signal<{ id: number; text: string }[]>([]);
  private _nextId = 0;
