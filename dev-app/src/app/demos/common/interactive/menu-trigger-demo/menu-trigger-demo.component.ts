...
// Source: demos/common/interactive/menu-trigger-demo/menu-trigger-demo.story.ts
...
@Component({
  selector: 'app-menu-trigger-demo',
  standalone: true,
  ...
  template: `
    <app-doc-shell title="Menu Trigger"
      ...
      overview="<p><code>[cngxMenuTrigger]</code> wires a button to a menu wrapped in a popover. Unlike <code>CngxListboxTrigger</code>, activating an item always closes the menu — consistent with desktop menu semantics.</p>"
      [apiComponents]="['CngxMenuTrigger', 'CngxMenu', 'CngxMenuItem']">
      <app-example-card title="Dropdown menu"
        [subtitle]="_s0"
...
export class MenuTriggerDemoComponent {
  ...
  protected readonly _srcTs0 = `import { CngxMenu, CngxMenuItem, CngxMenuTrigger } from '@cngx/common/interactive';
import { CngxPopover, CngxPopoverTrigger } from '@cngx/common/popover';
