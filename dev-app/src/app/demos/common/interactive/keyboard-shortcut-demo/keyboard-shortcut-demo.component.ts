...
// Source: demos/common/interactive/keyboard-shortcut-demo/keyboard-shortcut-demo.story.ts
...
@Component({
  selector: 'app-keyboard-shortcut-demo',
  standalone: true,
  ...
  template: `
    <app-doc-shell title="Keyboard Shortcut"
      description="Declarative keyboard shortcut handler. Supports mod (Meta/Ctrl), global/self scope, and input element filtering."
      overview="<p><code>[cngxKeyboardShortcut]</code> binds keyboard combos declaratively. <code>mod</code> resolves to Meta on macOS, Ctrl elsewhere. Global scope ignores events from input elements to prevent interference with typing.</p>"
      [apiComponents]="['CngxKeyboardShortcut']">
      <app-example-card title="Global Shortcut"
        [subtitle]="_s0"
  ...
  <div class="event-grid" style="margin-top:12px">
    ...
    <div class="event-row">
      ...
      <app-example-card title="Self-Scoped Shortcut"
        [subtitle]="_s1"
...
export class KeyboardShortcutDemoComponent {
  protected readonly _s0 = 'Press <code>Ctrl+K</code> (or <code>Cmd+K</code> on macOS) anywhere on the page. It will not fire while typing in the input field below — global scope filters input elements.';
  protected readonly _s1 = 'Escape only fires when this box has focus. Click it first, then press Escape.';
  protected readonly _srcHtml0 = `<div [cngxKeyboardShortcut]="'mod+k'" (shortcutTriggered)="handleGlobal()">
    <p style="font-size:0.875rem;margin:0 0 12px;color:var(--cngx-text-secondary,#666)">
      Try pressing <kbd style="padding:2px 6px;background:var(--code-bg,#f5f5f5);border:1px solid var(--code-border,#ddd);border-radius:3px;font-size:0.8rem">Ctrl+K</kbd> now.
      Then click into the input and try again — it won't fire.
    </p>
  ...
  protected readonly _srcTs0 = `import { CngxKeyboardShortcut } from '@cngx/common/interactive';
  ...
  protected readonly _srcHtml1 = `<div [cngxKeyboardShortcut]="'escape'" [shortcutScope]="'self'"
       (shortcutTriggered)="handleEscape()"
       tabindex="0"
       style="padding:16px;border:2px dashed var(--cngx-border,#ddd);border-radius:8px;
              max-width:300px;cursor:pointer;outline:none"
  ...
  protected readonly _srcTs1 = `import { CngxKeyboardShortcut } from '@cngx/common/interactive';
