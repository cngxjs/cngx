...
// Source: demos/common/interactive/option-demo/option-demo.story.ts
...
@Component({
  ...
  template: `
    <app-doc-shell title="Option"
      ...
      overview="<p><code>[cngxOption]</code> is the smallest selectable leaf of the listbox/menu stack. It provides <code>CNGX_AD_ITEM</code> via DI so the enclosing <code>CngxActiveDescendant</code> tracks it automatically. <code>[cngxOptionGroup]</code> wraps options under a labeled <code>role=&quot;group&quot;</code>.</p>"
      [apiComponents]="['CngxOption', 'CngxOptionGroup']">
      <app-example-card title="Flat options with AD"
        [subtitle]="_s0"
  ...
  <div class="event-grid" style="margin-top:12px">
    ...
    <div class="event-row">
      ...
      <app-example-card title="Grouped options"
        [subtitle]="_s1"
...
export class OptionDemoComponent {
  protected readonly _s0 = 'Arrow keys navigate. Enter/Space or click activates. Pointerenter follows the mouse without firing the activation output.';
  protected readonly _s1 = '<code>[cngxOptionGroup]</code> wraps options under a labeled <code>role="group"</code>. Navigation stays flat — groups are presentational only.';
  ...
  protected readonly _srcTs0 = `import { CngxActiveDescendant } from '@cngx/common/a11y';
import { CngxOption, CngxOptionGroup } from '@cngx/common/interactive';
...
.cngx-option--disabled {
  ...
  protected readonly _srcTs1 = `import { CngxActiveDescendant } from '@cngx/common/a11y';
import { CngxOption, CngxOptionGroup } from '@cngx/common/interactive';
