...
export class NavDemoComponent {
  ...
  protected readonly _srcHtml0 = `<nav class="nav-demo" style="width: 240px; border: 1px solid var(--cngx-color-border); border-radius: 6px; padding: 0.5rem 0; background: var(--cngx-surface-alt, #f9fafb);">
    @for (link of links; track link.path) {
      <a cngxNavLink [active]="activeLink() === link.path"
         (click)="activeLink.set(link.path); $event.preventDefault()"
         [href]="link.path"
  ...
  protected readonly _srcHtml1 = `<nav class="nav-demo" style="width: 240px; border: 1px solid var(--cngx-color-border); border-radius: 6px; padding: 0.5rem 0; background: var(--cngx-surface-alt, #f9fafb);">
    <span cngxNavLabel style="display: block; padding: 0.5rem 1rem; font-size: 0.75rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; color: var(--cngx-color-text-muted);">
      Application
    </span>
  ...
  protected readonly _srcHtml2 = `<nav class="nav-demo" style="width: 240px; border: 1px solid var(--cngx-color-border); border-radius: 6px; padding: 0.5rem 0; background: var(--cngx-surface-alt, #f9fafb);">
    <a cngxNavLink style="display: flex; align-items: center; justify-content: space-between; padding: 0.5rem 1rem; text-decoration: none; font-size: 0.875rem; color: var(--cngx-color-text);">
      Inbox
      <span cngxNavBadge [value]="12" ariaLabel="12 unread"
            style="background: var(--interactive, #f5a623); color: #fff; font-size: 0.7rem; font-weight: 700; padding: 0.1em 0.5em; border-radius: 10px; min-width: 1.2em; text-align: center;">
