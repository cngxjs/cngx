...
.caption { font-size: 0.875em; color: var(--cngx-text-muted, #6b7280); margin-top: 12px; }`,
  ...
  <cngx-checkbox [value]="false" [indeterminate]="true" [disabled]="true">Locked-mixed</cngx-checkbox>`,
    ...
    },
    {
      ...
      subtitle:
        '<code>cngx-checkbox</code> forwards <code>[checkGlyph]</code> and <code>[dashGlyph]</code> ' +
        'to the inner <code>cngx-checkbox-indicator</code>. Project a <code>TemplateRef&lt;void&gt;</code> ' +
        'each to replace the default ✓ / − glyphs with brand or design-system icons.',
      imports: ['CngxCheckbox'],
      template: `
