...
// Source: demos/common/card/card-grid-demo/card-grid-demo.story.ts
...
@Component({
  ...
  template: `
    <app-doc-shell title="Card Grid"
      ...
      overview="<p>CSS Grid with <code>auto-fill</code> + <code>minmax</code> — no breakpoints needed. <code>CngxRovingTabindex</code> is a host directive for arrow-key navigation between cards.</p><p>Empty states use <code>ng-template[cngxCardGridEmpty]</code> with reason matching and fallback.</p>"
      [apiComponents]="['CngxCardGrid', 'CngxCardGridEmpty']">
      <app-example-card title="Basic Grid"
        [subtitle]="_s0"
  ...
  <cngx-card-grid minWidth="180px">
    @for (item of items(); track item) {
      ...
      <app-example-card title="Density Variants"
        [subtitle]="_s1"
  ...
  <cngx-card-grid minWidth="140px" [density]="density()">
    @for (item of items(); track item) {
      ...
      <app-example-card title="Empty State with Reason"
        [subtitle]="_s2"
...
export class CardGridDemoComponent {
  protected readonly _s0 = 'Cards auto-fill with a minimum width of 180px. Resize the browser to see the grid reflow.';
  protected readonly _s1 = 'Toggle density to see gap and padding changes. <code>compact</code> for dashboards, <code>comfortable</code> for browsing.';
  protected readonly _s2 = 'Templates are matched by <code>emptyReason</code>. Select a reason to see the corresponding empty state.';
  protected readonly _srcHtml0 = `<cngx-card-grid minWidth="180px">
    @for (item of items(); track item) {
      <cngx-card as="button" [ariaLabel]="item">
        <header cngxCardHeader>
          <h3 style="margin:0;font-weight:600;font-size:0.9375rem">{{ item }}</h3>
  ...
  protected readonly _srcTs0 = `import { CngxCard, CngxCardHeader, CngxCardBody, CngxCardGrid, CngxCardGridEmpty } from '@cngx/common/card';
  ...
  protected readonly _srcTs1 = `import { CngxCard, CngxCardHeader, CngxCardBody, CngxCardGrid, CngxCardGridEmpty } from '@cngx/common/card';
  ...
  protected readonly _srcTs2 = `import { CngxCard, CngxCardHeader, CngxCardBody, CngxCardGrid, CngxCardGridEmpty } from '@cngx/common/card';
