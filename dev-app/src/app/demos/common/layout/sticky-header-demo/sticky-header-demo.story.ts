...
export const STORY: DemoSpec = {
  ...
  overview:
    '<p><code>[cngxStickyHeader]</code> does NOT apply <code>position: sticky</code> — CSS handles that. ' +
    'It inserts a sentinel element and uses <code>IntersectionObserver</code> to detect when the header is stuck, ' +
    'toggling the <code>cngx-sticky--active</code> CSS class.</p>',
  moduleImports: [
