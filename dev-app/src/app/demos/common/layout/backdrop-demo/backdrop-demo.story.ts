  ...
  sections: [
    {
      ...
      subtitle:
        'When visible, <code>[cngxBackdrop]</code> adds <code>inert</code> to all sibling elements — ' +
        'they become unfocusable and non-interactive. Click the backdrop to dismiss.',
