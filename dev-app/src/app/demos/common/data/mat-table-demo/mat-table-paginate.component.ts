...
// Source: demos/common/data/mat-table-demo/mat-table-paginate.story.ts
...
@Component({
  selector: 'app-mat-table-paginate-demo',
  standalone: true,
...
import { PEOPLE, type Person } from '../../../../fixtures';
  ...
  protected readonly _srcHtml1 = `<pre class="code-block"><code>// Component with CngxSort, CngxFilter, CngxPaginate as hostDirectives
@Component(&#123;
  hostDirectives: [
    &#123; directive: CngxSort &#125;,
    &#123; directive: CngxFilter &#125;,
