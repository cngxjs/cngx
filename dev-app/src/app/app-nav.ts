...
export const NAV_GROUPS: NavGroup[] = [
  {
    ...
    items: [
      ...
      { label: 'Search (Material)', path: 'common/behaviors/search-mat' },
      { label: 'Sort (Backend)', path: 'common/behaviors/sort-backend' },
      { label: 'Sort', path: 'common/behaviors/sort' },
      { label: 'Sort (Multi)', path: 'common/behaviors/sort-multi' },
      { label: 'DataSource', path: 'common/data/data-source' },
      { label: 'mat-table (Manual)', path: 'common/data/mat-table-manual' },
      { label: 'mat-table (Custom Paginate)', path: 'common/data/mat-table-paginate-custom' },
      { label: 'mat-table (Paginate)', path: 'common/data/mat-table-paginate' },
      { label: 'mat-table (Smart)', path: 'common/data/mat-table-smart' },
