 ...
 * ```
 * <example-url>http://localhost:4200/focus-restore/inline-details</example-url>
 * <example-url>http://localhost:4200/focus-restore/panel-with-automatic-restore</example-url>
 */
@Directive({
