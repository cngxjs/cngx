 ...
 * </div>
 * ```
 * <example-url>http://localhost:4200/roving-tabindex/horizontal-toolbar</example-url>
 * <example-url>http://localhost:4200/roving-tabindex/vertical-menu</example-url>
 */
@Directive({
