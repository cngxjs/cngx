...
3. **Typeahead is part of the directive surface, not a separate add-on.** `typeaheadDebounce` is configurable, the buffer is testable, and `skipDisabled` is respected during scanning.
