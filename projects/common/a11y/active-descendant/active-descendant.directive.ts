 ...
 * <example-url>http://localhost:4200/active-descendant/listbox-with-items-input</example-url>
 * <example-url>http://localhost:4200/active-descendant/typeahead</example-url>
 */
@Directive({
