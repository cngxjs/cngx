 ...
 * }
 * ```
 * <example-url>http://localhost:4200/aria-expanded/accordion-multiple-panels</example-url>
 * <example-url>http://localhost:4200/aria-expanded/disclosure-pattern</example-url>
 */
@Directive({
