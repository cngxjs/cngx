 ...
 * </div>
 * ```
 * <example-url>http://localhost:4200/disclosure/basic-uncontrolled</example-url>
 * <example-url>http://localhost:4200/disclosure/controlled-mode</example-url>
 * <example-url>http://localhost:4200/disclosure/faq-accordion</example-url>
 */
@Directive({
