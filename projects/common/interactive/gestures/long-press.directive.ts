 ...
 * </div>
 * ```
 * <example-url>http://localhost:4200/common/interactive/long-press/custom-threshold</example-url>
 * <example-url>http://localhost:4200/common/interactive/long-press/long-press-with-visual-feedback</example-url>
 */
@Directive({
