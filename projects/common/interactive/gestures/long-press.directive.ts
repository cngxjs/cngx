 ...
 * </div>
 * ```
 * <example-url>http://localhost:4200/long-press/custom-threshold</example-url>
 * <example-url>http://localhost:4200/long-press/long-press-with-visual-feedback</example-url>
 */
@Directive({
