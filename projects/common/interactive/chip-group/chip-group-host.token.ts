 ...
 * @github https://github.com/cngxjs/cngx/blob/main/projects/common/interactive/chip-group/chip-group-host.token.ts
 * @since 0.1.0
 */
 ...
 * @since 0.1.0
 */
export const CNGX_CHIP_GROUP_HOST = new InjectionToken<CngxChipGroupHost>('CngxChipGroupHost');
