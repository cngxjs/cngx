 ...
 * ```
 * <example-url>http://localhost:4200/error-state/basic-boolean-flag-flips-aria-invalid-aria-errormessage</example-url>
 * <example-url>http://localhost:4200/error-state/without-message-id-class-hook-aria-invalid-only</example-url>
 */
@Directive({
