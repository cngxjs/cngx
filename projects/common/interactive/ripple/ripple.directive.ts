 ...
 * ```
 * <example-url>http://localhost:4200/#/common/interactive/ripple/button-ripples</example-url>
 * <example-url>http://localhost:4200/#/common/interactive/ripple/card-with-ripple</example-url>
 */
@Directive({
  selector: '[cngxRipple]',
  exportAs: 'cngxRipple',
