 ...
 * ```
 * <example-url>http://localhost:4200/common/interactive/click-outside/dropdown</example-url>
 * <example-url>http://localhost:4200/common/interactive/click-outside/enabled-toggle</example-url>
 */
@Directive({
