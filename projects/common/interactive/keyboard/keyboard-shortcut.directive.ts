 ...
 * </div>
 * ```
 * <example-url>http://localhost:4200/keyboard-shortcut/global-shortcut</example-url>
 * <example-url>http://localhost:4200/keyboard-shortcut/self-scoped-shortcut</example-url>
 */
@Directive({
