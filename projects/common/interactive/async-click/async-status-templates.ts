 ...
 * ```
 * <example-url>http://localhost:4200/ui/async-button/random-outcome</example-url>
 * <example-url>http://localhost:4200/ui/async-button/string-labels</example-url>
 * <example-url>http://localhost:4200/ui/async-button/template-slots</example-url>
 */
