 ...
 * <example-url>http://localhost:4200/context-menu/right-click-target-zone</example-url>
 ...
 * <example-url>http://localhost:4200/menu/action-menu-with-separator</example-url>
 */
@Directive({
