 ...
 * @wcag AA
 * @github https://github.com/cngxjs/cngx/blob/main/projects/common/interactive/menu/menu-separator.directive.ts
 * @since 0.1.0
 * @relatedTo CngxMenu, CngxMenuItem, CngxMenuGroup
