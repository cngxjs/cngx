 ...
 * <example-url>http://localhost:4200/deviation-bar/async-state-machine</example-url>
 * <example-url>http://localhost:4200/deviation-bar/variance-readings</example-url>
 */
@Component({
