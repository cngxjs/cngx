 ...
 * <example-url>http://localhost:4200/stacked-bar/async-state-machine</example-url>
 * <example-url>http://localhost:4200/stacked-bar/proportional-share-strips</example-url>
 */
@Component({
