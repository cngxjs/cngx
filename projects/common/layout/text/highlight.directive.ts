 ...
 * </p>
 * ```
 * <example-url>http://localhost:4200/highlight/live-search-highlighting</example-url>
 * <example-url>http://localhost:4200/highlight/multiple-paragraphs</example-url>
 */
@Directive({
