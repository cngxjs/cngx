 ...
 * @category common/stepper/slots
 * @wcag AA
 * @github https://github.com/cngxjs/cngx/blob/main/projects/common/stepper/slots/step-busy-spinner.directive.ts
 * @since 0.1.0
 * @relatedTo CngxStepIndicator, CngxStepBadge, CngxStepRejection
