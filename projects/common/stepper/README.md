...
| `withStepperDefaultOrientation('horizontal' \| 'vertical')` | Default orientation when `[orientation]` is unbound. (`withDefaultOrientation` retained as a deprecated alias.) |
