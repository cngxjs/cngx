 ...
 * </cngx-empty-state>
 * ```
 * <example-url>http://localhost:4200/empty-state/default-no-icon-projected</example-url>
 * <example-url>http://localhost:4200/empty-state/inside-a-card-grid</example-url>
 * <example-url>http://localhost:4200/empty-state/inside-a-list</example-url>
 * <example-url>http://localhost:4200/empty-state/inside-a-table</example-url>
 * <example-url>http://localhost:4200/empty-state/with-custom-icon-actions</example-url>
 */
@Component({
