 ...
 * axis signal plus the visible/toggle label. Library defaults are English;
 * consumers relabel via {@link withA11yPanelAxes}.
 *
 * @category ui/a11y
 * @github https://github.com/cngxjs/cngx/blob/main/projects/ui/a11y/a11y-panel.config.ts
 * @since 0.1.0
 */
export interface CngxA11yPanelAxisOption {
 ...
 * value Reset restores (the axis' own library default). Reorder or drop
 * axes by supplying a subset via {@link withA11yPanelAxes}.
 *
 * @category ui/a11y
 * @github https://github.com/cngxjs/cngx/blob/main/projects/ui/a11y/a11y-panel.config.ts
 * @since 0.1.0
 */
export interface CngxA11yPanelAxisSpec {
  /** Which preference axis this group binds to. */
  readonly axis: CngxA11yPanelAxis;
  /** Ordered options rendered as toggle buttons. */
  readonly options: readonly CngxA11yPanelAxisOption[];
  /** Value Reset restores for this axis - its own library default. */
