 ...
 * ```
 * <example-url>http://localhost:4200/progress/circular-variant</example-url>
 * <example-url>http://localhost:4200/progress/linear-determinate</example-url>
 * <example-url>http://localhost:4200/progress/linear-indeterminate</example-url>
 */
@Component({
