...
@Component({
  ...
  template: `
    @for (toast of visibleToasts(); track toast.id) {
      <div
        ...
        [attr.role]="toast.config.severity === 'error' || toast.config.severity === 'warning' ? 'alert' : 'status'"
  ...
  styles: `
    ...
    .cngx-toast-outlet--top-start { top: 0; left: 0; }
    .cngx-toast-outlet--top-center { top: 0; left: 50%; transform: translateX(-50%); }
    .cngx-toast-outlet--top-end { top: 0; right: 0; }
    .cngx-toast-outlet--bottom-start { bottom: 0; left: 0; }
    .cngx-toast-outlet--bottom-center { bottom: 0; left: 50%; transform: translateX(-50%); }
    .cngx-toast-outlet--bottom-end { bottom: 0; right: 0; }
    ...
    .cngx-toast {
      ...
      pointer-events: auto;
      animation: cngx-toast-enter 200ms ease-out;
    }

    .cngx-toast--info { border-left: var(--cngx-toast-accent-width, 3px) solid var(--cngx-toast-info-accent, #3b82f6); }
    .cngx-toast--success { border-left: var(--cngx-toast-accent-width, 3px) solid var(--cngx-toast-success-accent, #22c55e); }
    .cngx-toast--warning { border-left: var(--cngx-toast-accent-width, 3px) solid var(--cngx-toast-warning-accent, #f59e0b); }
    .cngx-toast--error { border-left: var(--cngx-toast-accent-width, 3px) solid var(--cngx-toast-error-accent, #ef4444); }

    .cngx-toast__icon {
      flex-shrink: 0;
    }

    .cngx-toast--info .cngx-toast__icon { color: var(--cngx-toast-info-accent, #3b82f6); }
    .cngx-toast--success .cngx-toast__icon { color: var(--cngx-toast-success-accent, #22c55e); }
    .cngx-toast--warning .cngx-toast__icon { color: var(--cngx-toast-warning-accent, #f59e0b); }
    .cngx-toast--error .cngx-toast__icon { color: var(--cngx-toast-error-accent, #ef4444); }
    ...
    .cngx-toast__dismiss {
      ...
      background: none;
      border: none;
      padding: var(--cngx-toast-dismiss-padding, 4px);
      cursor: pointer;
      color: inherit;
      opacity: var(--cngx-toast-dismiss-opacity, 0.5);
      border-radius: var(--cngx-toast-dismiss-radius, 4px);
    }

    .cngx-toast__dismiss:hover { opacity: var(--cngx-toast-dismiss-hover-opacity, 1); }

    .cngx-toast__dismiss:focus-visible {
      outline: 2px solid currentColor;
      outline-offset: 2px;
    }

    .cngx-toast__dismiss svg {
      width: var(--cngx-toast-dismiss-icon-size, 16px);
      height: var(--cngx-toast-dismiss-icon-size, 16px);
    }
...
export class CngxToastOutlet {
  ...
  protected readonly positionClass = computed(
    () => `cngx-toast-outlet--${this.position()}`,
  );
