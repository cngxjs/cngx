 ...
 * ```
 * <example-url>http://localhost:4200/forms/numeric/basic-numeric-input</example-url>
 * <example-url>http://localhost:4200/forms/numeric/locale-formatting</example-url>
 * <example-url>http://localhost:4200/forms/numeric/min-max-step-decimals</example-url>
 */
@Directive({
