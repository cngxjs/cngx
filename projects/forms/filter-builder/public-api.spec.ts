...
describe('@cngx/forms/filter-builder — public-api re-exports', () => {
  ...
  it('re-exports tree-model types so consumers can type FilterFieldDef[] without reaching into src/', () => {
    ...
    const expression: FilterExpression = { type: 'expression', id: 'e1', field: 'name', operator: 'eq', value: 'x' };
    const group: FilterGroup = { type: 'group', id: 'g1', logic: 'and', negated: false, filters: [expression] };
