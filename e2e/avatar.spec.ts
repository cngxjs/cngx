...
test.describe('CngxAvatar demo', () => {
  test('renders size variants', async ({ page }) => {
    await page.goto('/#/common/display/avatar/sizes');
    const avatars = page.locator('.cngx-ex-artifact cngx-avatar');
  ...
  test('status dot has aria-label', async ({ page }) => {
    await page.goto('/#/common/display/avatar/shapes-and-status');
  ...
  test('square shape applies class', async ({ page }) => {
    await page.goto('/#/common/display/avatar/shapes-and-status');
    const square = page.locator('.cngx-ex-artifact cngx-avatar.cngx-avatar--square');
