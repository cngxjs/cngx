...
//
// The story's filesystem path relative to examples/stories/ becomes:
//   - the route slug (forms/select/single-select/clearable)
//   - the component file path (features/forms/select/single-select/clearable.component.ts)
//   - the navigation tree (lib > category > demo > example)
//
// No manifest, no sections, no per-section pruning — one story = one example.
//
